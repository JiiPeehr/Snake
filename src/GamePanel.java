...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics g) {
        ...
        if (running) {
            ...
            g.drawString("Score: " + applesEaten, (SCREEN_WIDHT - metrics.stringWidth("Score: " + applesEaten)) / 2,
                    g.getFont().getSize());
        } else {
            gameOver(g);
        }
    ...
    public void checkCollisions() {
        ...
        // checks if head touches to border
        if (y[0] < 0) {
            running = false;
        }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Score: " + applesEaten, (SCREEN_WIDHT - metrics1.stringWidth("Score: " + applesEaten)) / 2,
                g.getFont().getSize());
        // Game over text
        g.setColor(Color.red);
